...
class Photon(Boson):
    ...
    def get_I(self, full=False):
        ...
        if type(self._mf) is mqed.qedhf.RHF:
            ...
            eri_mo = ao2mo.general(bare_eri, [mo_coeff,]*4, compact=False).reshape([self.nmo,]*4)
        ...
        # SC-QED-HF: Apply Gaussian factors in dipole basis, then transform to MO
            ...
            for mode in range(self.nmodes):
                ...
                eri_dipole = numpy.einsum("pu, qv, rw, st, pqrs-> uvwt",
                                          U_ao2dip, U_ao2dip, U_ao2dip, U_ao2dip, bare_eri,
                                          optimize=True)
                ...
                eri_mo = ao2mo.general(eri_dipole, [C_dipole,]*4, compact=False).reshape([self.nmo,]*4)
        ...
        # VT-QED-HF: Gaussian factors + residual DSE
            ...
            for mode in range(self.nmodes):
                ...
                g_dipole = numpy.einsum("pu, pq, qv-> uv", U_ao2dip, self.gmat[mode], U_ao2dip)
